...
public class WordGuessGame {
	...
	public Feedback[] guess(String guess) {
		...
		markGreens(guess, feedbacks, usedLetters);
		markYellowsAndGrays(guess, feedbacks, usedLetters);
	
		return feedbacks;
	}

	private void markGreens(String guess, Feedback[] feedbacks, boolean[] usedLetters) {
	...
	private void markYellowsAndGrays(String guess, Feedback[] feedbacks, boolean[] usedLetters) {
	    for (int i = 0; i < Constants.WORD_LENGTH; i++) {
	        if (feedbacks[i] == null) {
